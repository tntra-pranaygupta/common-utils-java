...
class TransactionServiceImplTest {
    ...
    class CreateTransactionTests {
        ...
        void testCreateTransactionSuccessfullyTest() {
            ...
            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-123", "4532", "VISA", new BigDecimal("100.00"), "GBP"
            );
            ...
            assertThat(response)
                    .isNotNull()
                    .extracting("externalId", "panLastFour", "cardScheme", "currency", "status")
                    .containsExactly("ext-123", "4532", "VISA", "GBP", "PENDING");
        ...
        void testCreateTransactionWithExplicitCorrelationIdTest() {
            ...
            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-456", "5678", "MASTERCARD", new BigDecimal("250.50"), "USD"
            );
        ...
        void testCreateTransactionWithMdcCorrelationIdTest() {
            ...
            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-789", "9012", "AMEX", new BigDecimal("500.00"), "EUR"
            );
         ...
         * Verifies: panToken is correctly masked.
         */
        @Test
        void testCreateTransactionMasksLuhnPanTest() {
            TransactionRequestDto requestDto = buildValidTransactionRequest();
            String panLastFour = "1234";
            requestDto.setPanLastFour(panLastFour);

            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-lun", panLastFour, "VISA", new BigDecimal("150.00"), "GBP"
            );
            String maskedPan = LuhnAlgorithm.maskPan(panLastFour);
            savedEntity.setPanToken(maskedPan);
            ...
            verify(repository, times(1)).save(argThat(transaction ->
                    transaction.getPanToken() != null &&
                            transaction.getPanToken().equals(maskedPan)
            ));
        }
        ...
        void testCreateTransactionStatusIsPendingTest() {
            TransactionRequestDto requestDto = buildValidTransactionRequest();
            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-pending", "1234", "VISA", new BigDecimal("75.50"), "GBP"
            );
        ...
        void testCreateTransactionGeneratesUniqueExternalIdTest() {
            ...
            FinancialTransaction savedEntity1 = buildFinancialTransaction(
                    "ext-id-1", "1111", "VISA", new BigDecimal("100.00"), "GBP"
            );
            FinancialTransaction savedEntity2 = buildFinancialTransaction(
                    "ext-id-2", "2222", "MASTERCARD", new BigDecimal("200.00"), "USD"
            );
        ...
        void testCreateTransactionAuditLoggingTest() {
            ...
            FinancialTransaction savedEntity = buildFinancialTransaction(
                    "ext-audit", "5678", "VISA", new BigDecimal("350.75"), "JPY"
            );
    ...
    class GetTransactionByIdTests {
        ...
        void testGetTransactionByExternalIdSuccessfullyTest() {
            ...
            FinancialTransaction entity = buildFinancialTransaction(
                    externalId, "4532", "VISA", new BigDecimal("225.00"), "GBP"
            );
            ...
            assertThat(response)
                    .isNotNull()
                    .extracting("externalId", "panLastFour", "cardScheme", "status")
                    .containsExactly(externalId, "4532", "VISA", "PENDING");
        ...
        void testGetTransactionMapsAllFieldsTest() {
            ...
            entity.setPanToken("masked-token");
            entity.setPanLastFour("1111");
    ...
    class GetAllTransactionsTests {
        ...
        void testGetAllTransactionsSuccessfullyTest() {
            List<FinancialTransaction> entities = Arrays.asList(
                    buildFinancialTransaction("ext-1", "1111", "VISA", new BigDecimal("100.00"), "GBP"),
                    buildFinancialTransaction("ext-2", "2222", "MASTERCARD", new BigDecimal("200.00"), "USD"),
                    buildFinancialTransaction("ext-3", "3333", "AMEX", new BigDecimal("300.00"), "EUR")
            );
        ...
        void testGetAllTransactionsSingleItemTest() {
            FinancialTransaction entity = buildFinancialTransaction(
                    "ext-single", "5555", "VISA", new BigDecimal("777.77"), "GBP"
            );
        ...
        void testGetAllTransactionsMapsAllFieldsTest() {
            ...
            assertThat(responses.get(0))
                    .extracting("externalId", "panLastFour", "status", "createdBy")
                    .containsExactly("ext-1", "1111", "SETTLED", "user1");
            assertThat(responses.get(1))
                    .extracting("externalId", "panLastFour", "status", "createdBy")
                    .containsExactly("ext-2", "2222", "PENDING", "user2");
        }
    }
    ...
    class EdgeCasesAndIntegrationTests {
        ...
        void testTransactionWithAllOptionalFieldsTest() {
            ...
            entity.setId(1L);
            entity.setExternalId(externalId);
            entity.setPanToken("masked");
            entity.setPanLastFour("9999");
            entity.setCardScheme("VISA");
    ...
    private TransactionRequestDto buildValidTransactionRequest() {
        ...
        dto.setPanToken("pan-token-123");
        dto.setPanLastFour("1234");
    ...
    private FinancialTransaction buildFinancialTransaction(
        ...
        transaction.setPanToken("masked-token");
        transaction.setPanLastFour(panLastFour);
